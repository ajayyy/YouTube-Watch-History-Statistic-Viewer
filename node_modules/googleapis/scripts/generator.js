...
class Generator {
    ...
    constructor(options = {}) {
        ...
        swig.setFilter('buildurl', generator_utils_1.buildurl);
    ...
    generateAllAPIs(callback) {
        ...
        this.makeRequest({ uri: DISCOVERY_URL, headers }, (err, resp) => {
            ...
            const queue = async.queue((api, next) => {
                ...
                async.retry(3, this.generateAPI.bind(this, api.discoveryRestUrl), (e, results) => {
                    if (e) {
                        ...
                        console.log(api.id + '\n-----------\n' +
                            util.inspect(this.state[api.discoveryRestUrl], {
                                maxArrayLength: null
                            }) +
                            '\n');
                    }
    ...
    generateIndex(callback) {
        ...
        const contents = js_beautify_1.js_beautify(result, BEAUTIFY_OPTIONS);
