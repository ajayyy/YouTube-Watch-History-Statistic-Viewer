...
function makeMethod(schema, method, context) {
    return (params, callback) => {
        const schemaUrl = generator_utils_1.buildurl(schema.rootUrl + schema.servicePath + method.path);
        const parameters = {
            options: {
        ...
        if (method.mediaUpload && method.mediaUpload.protocols &&
            ...
            const mediaUrl = generator_utils_1.buildurl(schema.rootUrl + method.mediaUpload.protocols.simple.path);
...
Discovery.prototype.discoverAPI = function (apiDiscoveryUrl, callback) {
    ...
    if (typeof apiDiscoveryUrl === 'string') {
        ...
        apirequest_1.createAPIRequest(parameters, _generate);
    }
};
